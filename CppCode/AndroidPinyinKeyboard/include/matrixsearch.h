...
class MatrixSearch {
 private:
  ...
  size_t extend_mtrx_nd(MatrixNode *mtrx_nd, LmaPsbItem lpi_items[],
	  size_t lpi_num, PoolPosType dmi_fr, size_t res_row, double pinyin_score);
 ...
 public:
  ...
  size_t search(const char *py, size_t py_len, Position *pos);
